	...
	<div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<c:url value='/quan-tri/bai-viet/danh-sach?page=1&limit=5'/>">Bài Viết</a></li>
				<c:if test="${not empty model.id}">
					<li class="active">Cập nhập bài viết</li>
				</c:if>
				<c:if test="${empty model.id}">
					<li class="active">Thêm bài viết</li>
				</c:if>
